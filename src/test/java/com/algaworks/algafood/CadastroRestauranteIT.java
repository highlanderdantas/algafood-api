...
public class CadastroRestauranteIT {
	...
	private static final String VIOLACAO_DE_REGRA_DE_NEGOCIO_PROBLEM_TYPE = ProblemType.ERRO_NEGOCIO.getTitle();

	private static final String DADOS_INVALIDOS_PROBLEM_TITLE = ProblemType.DADOS_INVALIDOS.getTitle();
